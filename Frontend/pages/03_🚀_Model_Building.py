...
col1.markdown("""<p> In this strategy, a $100 bet is taken when the model gives the home
...
col2.markdown("""<p> In this strategy, we convert the odds we get from the bookmaker into implied 
